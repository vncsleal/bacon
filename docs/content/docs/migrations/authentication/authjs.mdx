...
<Warning>
bacon support for Auth.js is currently blocked by [this issue](https://github.com/nextauthjs/next-auth/issues/11076).
</Warning>

Note: bacon now uses Better Auth by default. If you have switched to Clerk or are migrating an existing Clerk-based project to Auth.js, here's how.
