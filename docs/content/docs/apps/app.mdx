---
title: App
description: How the main application works in bacon.
---
...
bacon exports the main app from the `apps/app` directory. It is designed to be run on a subdomain of your choice, and is used to run the main user-facing application.
