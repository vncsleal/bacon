---
title: Components
description: bacon offers a default component library by shadcn/ui
---

bacon contains a design system out of the box powered by [shadcn/ui](https://ui.shadcn.com/).
