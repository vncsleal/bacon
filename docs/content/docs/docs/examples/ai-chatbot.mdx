...
description: Let's use bacon to create a simple AI chatbot.
---

Today we're going to create an AI chatbot using bacon and the built-in AI package, powered by [Vercel AI SDK](https://sdk.vercel.ai/).
...
```bash title="Terminal"
npx bacon@latest init ai-chatbot
```
...
That's it! You've now created an AI chatbot using bacon and the built-in AI package. If you have any questions, please reach out to me on [Twitter](https://x.com/haydenbleasel) or open an issue on [GitHub](https://github.com/vncsleal/bacon).
